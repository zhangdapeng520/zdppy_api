...
from zdppy_api.uvicorn.protocols.http.flow_control import (
    CLOSE_HEADER,
    HIGH_WATER_LIMIT,
    FlowControl,
    service_unavailable,
)
from zdppy_api.uvicorn.protocols.utils import (
    get_client_addr,
    get_local_addr,
...
class H11Protocol(asyncio.Protocol):
    ...
    def handle_upgrade(self, event):
        ...
        if upgrade_value != b"websocket" or self.ws_protocol_class is None:
            ...
            from zdppy_api.uvicorn.protocols.websockets.auto import AutoWebSocketsProtocol
